...
#
#         print(f"model: {pred_value_score}")
#
#         credibility_score = (
...
class FinancialNewsCredibilityAnalyzer:
    def __init__(self, model_path="E:\\saved_models\\fake_news_detection_model\\credibility_model.zip"):
        ...
        self.model = Pipeline([
            ...
            ('feature_selection', SelectKBest(f_classif, k=1000)),  # Select top 1000 features
            ('classifier', LinearSVC(
                C=0.05,  # Lower C value to reduce complexity and prevent overfitting
                max_iter=10000,
    ...
    def _save_model(self):
        os.makedirs("E:\\saved_models\\fake_news_detection_model", exist_ok=True)
    ...
    def get_credibility(self, credibility_score):
        credibility_texts = ['Highly Suspicious', 'Unreliable', 'Uncertain', 'Likely Credible', 'Highly Credible']
        credibility_index = int(min(max(credibility_score, 0), 1) * 5)
